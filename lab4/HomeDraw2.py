...
d.ellipse(med, (77, 77, 77), (313, 557, 215, 70))
d.ellipse(med, (0, 0, 0), (339, 579, 162, 48), 1)
d.ellipse(med, (22, 80, 68), (340, 580, 160, 46))
d.line(med, (0, 0, 1), (449, 242), (454, 593))
...
med1 = pygame.transform.scale(med, (211, 300))
med2 = pygame.transform.scale(med, (280, 400))
med3 = pygame.transform.flip(med, 1, 0)
med4 = pygame.transform.scale(med3, (211, 300))
